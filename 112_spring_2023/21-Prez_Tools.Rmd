...
Below is some sample content to test out some of these output options. I've set everything up in the header of [this Rmd](template_rmd/21-Prez_Tools.Rmd) file. All you have to do is knit it with different options and check out the output html file.
